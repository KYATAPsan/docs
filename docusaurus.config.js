...
const config = {
  title: "24san Server",
  tagline: "Free Web & Analytics Suite for 24san Minecraft Server",
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        logo: {
          alt: "24san Logo",
          src: "https://github.com/KYATAPsan/mc.24san.github.io/blob/main/panel_images/bedrock/Back_KYATAP.png?raw=true",
        },
        items: [
          {
            type: "doc",
